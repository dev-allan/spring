...
public class FilmController {
  ...
  @GetMapping("/byDate")
  public List<FilmCompletDto> findFilmsByReleaseDate(@RequestParam LocalDate date) {
    return this.service.findByDate(date).stream().map(film -> mapper.convertValue(film, FilmCompletDto.class)).toList();
  }
}
